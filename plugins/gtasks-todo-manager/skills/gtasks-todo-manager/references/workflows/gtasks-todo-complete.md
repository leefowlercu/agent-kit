# Workflow: Complete Task in Google Tasks

## Expected Input

[task description]

This skill marks a task as completed in Google Tasks.

## Argument Handling

### When Request Details Are Provided

If the user provided request details, intelligently parse them to identify the task to complete.
...
If the user did not provide request details:
