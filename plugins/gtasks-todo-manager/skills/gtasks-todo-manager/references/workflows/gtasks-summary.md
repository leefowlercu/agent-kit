# Workflow: Google Tasks Summary

## Expected Input

[scope]

This skill displays a summary of tasks and task lists across all configured Google accounts.

## Argument Handling

### When Request Details Are Provided

If the user provided request details, check for project context or scope specification.
...
If the user did not provide request details, show the full cross-account summary.
