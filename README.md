...
| [gtasks-todo-manager](plugins/gtasks-todo-manager) | Manages to-dos across multiple Google accounts using the Google Tasks API | 0.3.2 |
...
│       │   ├── gtasks-project-init.md      # Initialize project list
│       │   └── gtasks-project-status.md    # Project status command
│       └── skills/
│           └── gtasks-todo-manager/
